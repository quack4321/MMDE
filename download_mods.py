...
def get_latest_version(namespace, name):
    ...
    try:
        ...
        with urllib.request.urlopen(req) as response:
            ...
            # The API returns the newest version info under the 'latest' key
...
def install_dependencies():
    ...
    print(f"Found {len(dependencies)} dependencies. Fetching latest versions...\n")
    ...
    for dep in dependencies:
        ...
        if os.path.exists(zip_filepath):
            ...
            time.sleep(0.5) # Polite API pacing before the next loop
            continue
